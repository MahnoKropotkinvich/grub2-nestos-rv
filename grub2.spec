...
%changelog
* Tue Mar 25 2025 Nicolas Frayer <nfrayer@redhat.com> 2.12-17
- ieee1275/ofnet: Fix grub_malloc() removed after added safe

* Mon Mar 10 2025 Leo Sandoval <lsandova@redhat.com> 2.12-16
- Remove 'fs/ntfs: Implement attribute verification' patch
- Resolves: #2350327

* Wed Mar 5 2025 Nicolas Frayer <nfrayer@redhat.com> 2.12-15
- fs/ext2: Rework out-of-bounds read for inline and external extents
- Resolves: #2346804

* Wed Mar 5 2025 Nicolas Frayer <nfrayer@redhat.com> 2.12-14
...
* Wed Dec 4 2024 Nicolas Frayer <nfrayer@redhat.com> 2.12-13
- spec: Fix posttrans

* Wed Dec 04 2024 Marta Lewandowska <mlewando@redhat.com> - 2.12-12
- fix last two changelog dates

* Mon Dec 02 2024 Marta Lewandowska <mlewando@redhat.com> - 2.12-11
- 99-grub-mkconfig.install: on PPC systems, remove petiboot's version checks

* Mon Dec 02 2024 Marta Lewandowska <mlewando@redhat.com> - 2.12-10
